<x-app-layout class="content-body">
    ...
    <input type="hidden" value="{{ $dez }}" id="dez">
   	...
   	<input type="hidden" value="{{ $andre }}" id="andre">
    <input type="hidden" value="{{ $lucas }}" id="lucas">
    <input type="hidden" value="{{ $simaozelote }}" id="simaozelote">
    <input type="hidden" value="{{ $mateus }}" id="mateus">
    <input type="hidden" value="{{ $tome }}" id="tome">
    <input type="hidden" value="{{ $oficiaiseprofessores }}" id="oficiaiseprofessores">
    <input type="hidden" value="{{ $catecumenos }}" id="catecumenos">
    <input type="hidden" value="{{ $daniel }}" id="daniel">
   	<input type="hidden" value="{{ $jonas }}" id="jonas">
